...
export class News extends Component {
 ...
 async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=733ef8b9aa1245a69a7f4c1c0d28ba78&page=${this.state.page}&pageSize=${this.props.pageSize}`;
