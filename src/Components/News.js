...
// loading k case me 2 cheez humne use ki 1: this.setState({loading:true});  mtlb condition true hogi jab load ho rha ho ,
// 2:   loading : false  , jab loading nahi rhi hogi
